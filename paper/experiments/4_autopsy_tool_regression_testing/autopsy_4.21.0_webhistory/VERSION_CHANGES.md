# Autopsy Version Changes: 4.20.0 → 4.21.0

**Generated:** 2026-02-06
**Experiment:** autopsy_4.21.0_webhistory
**Analysis Type:** Web History Forensic Artifacts
**Source:** Automated comparison using excel_comparator heatmap tool
**Comparison File:** `changes_4.20.0_to_4.21.0.json`
...
- **Heatmap Comparison:** `output/changes_4.20.0_to_4.21.0.json`
- **Reference Excel:** `shared/data/Report_4.21.0_reference.xlsx`
