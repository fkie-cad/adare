# Autopsy Version Changes: 4.19.0 → 4.19.1

**Generated:** 2026-02-06
**Experiment:** autopsy_4.19.1_webhistory
**Analysis Type:** Web History Forensic Artifacts
**Source:** Automated comparison using excel_comparator heatmap tool
**Comparison File:** `changes_4.19.0_to_4.19.1.json`
...
- **Heatmap Comparison:** `output/changes_4.19.0_to_4.19.1.json`
- **Reference Excel:** `shared/data/Report_4.19.1_reference.xlsx`
