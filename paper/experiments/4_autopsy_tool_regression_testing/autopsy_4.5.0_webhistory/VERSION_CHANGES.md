# Autopsy Version Changes: 4.4.1 → 4.5.0

**Generated:** 2026-02-06
**Experiment:** autopsy_4.5.0_webhistory
**Analysis Type:** Web History Forensic Artifacts
**Source:** Automated comparison using excel_comparator heatmap tool
**Comparison File:** `changes_4.4.1_to_4.5.0.json`
...
- **Heatmap Comparison:** `output/changes_4.4.1_to_4.5.0.json`
- **Reference Excel:** `shared/data/Report_4.5.0_reference.xlsx`
