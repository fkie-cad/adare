# Autopsy Version Changes: 4.11.0 → 4.12.0

**Generated:** 2026-02-06
**Experiment:** autopsy_4.12.0_webhistory
**Analysis Type:** Web History Forensic Artifacts
**Source:** Automated comparison using excel_comparator heatmap tool
**Comparison File:** `changes_4.11.0_to_4.12.0.json`

---

## Summary

**No detectable changes** between these versions. Schema and data are identical.
...
- **Low:** No changes affecting forensic analysis
...
- **Heatmap Comparison:** `output/changes_4.11.0_to_4.12.0.json`
- **Reference Excel:** `shared/data/Report_4.12.0_reference.xlsx`
