# Autopsy Version Changes: 4.6.0 → 4.7.0

**Generated:** 2026-02-06
**Experiment:** autopsy_4.7.0_webhistory
**Analysis Type:** Web History Forensic Artifacts
**Source:** Automated comparison using excel_comparator heatmap tool
**Comparison File:** `changes_4.6.0_to_4.7.0.json`
...
- **Heatmap Comparison:** `output/changes_4.6.0_to_4.7.0.json`
- **Reference Excel:** `shared/data/Report_4.7.0_reference.xlsx`
