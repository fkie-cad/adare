...
from adarevm.msghandler.strategies.mcp_experiment_handler import AdaptiveExperimentHandler
...
class AdareWsProtocolHandler(MessageHandler):
    def __init__(self):
        ...
        self.handlers = {
            ...
            EXPERIMENT.command_type: AdaptiveExperimentHandler()  # Use adaptive handler
        }
