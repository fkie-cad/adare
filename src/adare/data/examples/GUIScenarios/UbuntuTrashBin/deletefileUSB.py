...
class deletefileUSB(experiment):
    ...
    def prepare(self):
        file = "/media/vagrant/TESTUSB/testfile"
    ...
    def run(self):
        ...
        if guibot.exists('files_taskbar.png'):
            ...
            return -1
        if guibot.exists('testusb_in_files.png'):
            guibot.click('testusb_in_files.png').idle(10)
        else:
            log.error('testusb_in_files.png button does not exist')
            return -1
