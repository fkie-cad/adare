...
class deletefileSMB(Scenario):
    ...
    def run(self):
        ...
        if guibot.exists('otherlocations_computer_mnt_files.png'):
            ...
            return -1
        if guibot.exists('otherlocations_computer_mnt_smb_files.png'):
            guibot.double_click('otherlocations_computer_mnt_smb_files.png').idle(10)
        else:
            log.error('otherlocations_computer_mnt_smb_files.png button does not exist')
            return -1
