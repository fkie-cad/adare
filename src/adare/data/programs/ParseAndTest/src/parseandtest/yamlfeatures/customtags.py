...
class YamlCustomTag(yaml.YAMLObject):
    ...
    def set_variables(self, variables: dict):
        self.string = helper.resolve_variable_in_string(self.string, variables, regex=False)
...
class YamlRegexString(YamlCustomTag):
    ...
    def set_variables(self, variables: dict):
        self.string = helper.resolve_variable_in_string(self.string, variables, regex=True)
