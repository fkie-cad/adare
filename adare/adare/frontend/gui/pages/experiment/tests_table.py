...
from adare.frontend.gui.extensions.advanced_table.filters import FilterEqual, FilterNotEqual, FilterContains
from adare.frontend.gui.extensions.advanced_table.advanced_table import AdvancedTable
