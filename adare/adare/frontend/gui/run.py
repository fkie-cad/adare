...
from adare.frontend.gui.pages.experiment import index as experiment_page
from adare.frontend.gui.pages.request import index as request_page
from adare.frontend.gui.pages.login import index as login_page
from adare.frontend.gui.pages.experimentrun import index as runs_page
from adare.frontend.gui.pages.log import index as log_page
