...
class WebSocketCommand:
    ...
    def to_playbook_action(self) -> Dict[str, Any]:
        ...
        elif self.command_type == "key_combination":
            return {
                "keyboard": {
        ...
        elif self.command_type == "screenshot":
            return {
                "screenshot": {
        ...
        elif self.command_type == "command":
            return {
                "command": {
