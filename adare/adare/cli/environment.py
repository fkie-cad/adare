...
from adare.backend.environment.commands import environment_load, environment_list, environment_create, environment_delete
...
def exec_environment_list(arguments):
    project_directory = determine_projectdirectory(arguments.project)
    environment_list(project_directory)
