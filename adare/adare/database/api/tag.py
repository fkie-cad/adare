...
from adare.database.models.global_models import Environment, GlobalBase, Tag
...
class TagApi(EnhancedDatabaseApi):
    ...
    def get_or_create_tag(self, name: str, description: str | None = None) -> tuple[Tag, bool]:
        """
    ...
    def get_tag_usage_stats(self, tag_id: str | None = None) -> dict[str, Any]:
        """
