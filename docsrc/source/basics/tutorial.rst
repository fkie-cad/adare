...
- ADARE installed (:doc:`installation`)
...
- **Projects**: :doc:`projects` - Project structure and management
- **Environments**: :doc:`environments` - VM configuration and setup
- **Experiments**: :doc:`experiments` - Experiment structure and metadata
- **Actions**: :doc:`actions` - Complete playbook automation guide
- **Test Functions**: :doc:`testfunctions/index` - Forensic validation functions