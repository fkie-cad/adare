...
- [ ] in adare vm add way to delete single snapshots (or list of them)
- [ ] add way to delete all vms at once? make with additonal request!
...
#### Bugs
- [x] always run on base snapshot and create one after the experiment run not before (if specific option is set) -> test
